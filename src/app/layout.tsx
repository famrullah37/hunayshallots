...
const productCatalogSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, item: { "@type": "Product", name: "Fried Garlic Pouch 100gr", description: "Premium crispy fried garlic, 100 gram pouch, aromatic and golden.", brand: { "@type": "Brand", name: "Hunay" }, offers: { "@type": "Offer", priceCurrency: "IDR", price: "25000", availability: "https://schema.org/InStock" } } },
    { "@type": "ListItem", position: 4, item: { "@type": "Product", name: "Fried Garlic Jar 150gr", description: "Premium fried garlic in glass jar, 150 gram, crispy and long-lasting.", brand: { "@type": "Brand", name: "Hunay" }, offers: { "@type": "Offer", priceCurrency: "IDR", price: "35000", availability: "https://schema.org/InStock" } } },
    { "@type": "ListItem", position: 5, item: { "@type": "Product", name: "Fried Garlic Bottle 75gr", description: "Fried garlic in 75gr bottle, perfect as souvenir or gift.", brand: { "@type": "Brand", name: "Hunay" }, offers: { "@type": "Offer", priceCurrency: "IDR", price: "20000", availability: "https://schema.org/InStock" } } },
    { "@type": "ListItem", position: 6, item: { "@type": "Product", name: "Hunay Sambal Varieties", description: "Authentic Hunay sambal collection with various spicy flavor options.", brand: { "@type": "Brand", name: "Hunay" }, offers: { "@type": "Offer", priceCurrency: "IDR", price: "25000", availability: "https://schema.org/InStock" } } },
  ],
};
