...
const translations = {
  id: {
    ...
    "company.desc4": "ekspor ke Jepang, Korea, Kanada, Singapura, Amerika, dan Australia",
    "company.desc5":
    ...
    "company.achievement1": "Ekspor ke 6 Negara",
    "company.achievement1Desc": "Jepang, Korea, Kanada, Singapura, Amerika, Australia",
  ...
  en: {
    ...
    "company.desc4": "exporting to Japan, Korea, Canada, Singapore, USA, and Australia",
    "company.desc5":
    ...
    "company.achievement1": "Export to 6 Countries",
    "company.achievement1Desc": "Japan, Korea, Canada, Singapore, USA, Australia",
